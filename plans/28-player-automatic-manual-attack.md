...
- [x] Automatic mode does not attack when no target is in range. Manual mode ignores automatic acquisition and preserves current mouse-facing plus held left-mouse/`J` behavior.
