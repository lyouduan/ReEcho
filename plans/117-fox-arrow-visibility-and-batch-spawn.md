...
- 本地规划 / 实现基线：`origin/main@3cd7da8fc29bfa98383df850c0a3718d52faf362`。
...
- [ ] FullRebuild、相关自动化、项目校验、prebuilt check、资产只读审计和 `git diff --check` 通过。
- [ ] 未提交精选预构建包之外的 UE 生成物或机器路径。

## Step 0 门禁

- 基线分支/提交：`origin/main@3cd7da8fc29bfa98383df850c0a3718d52faf362`。
