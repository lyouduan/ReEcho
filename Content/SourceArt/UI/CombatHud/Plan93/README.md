...
本目录归档用户为 Plan93 提供的“正式-UI视觉/战斗场景”交付。`References/1-战斗场景.png` 是 1920×1080 构图参考，只用于 WBP 对照；`Elements/` 保留 9 张透明 PNG 原始切图，其中 `技能栏.png` 已被用户明确判定为废案，仅归档、不导入运行时，其余 8 张用于正式 HUD。
