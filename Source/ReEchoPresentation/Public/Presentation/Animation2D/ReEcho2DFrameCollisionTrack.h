...
struct REECHOPRESENTATION_API FReEcho2DCollisionPolygon
{
	GENERATED_BODY()
...
struct REECHOPRESENTATION_API FReEcho2DFrameCollision
{
	GENERATED_BODY()
...
class REECHOPRESENTATION_API UReEcho2DFrameCollisionTrack : public UDataAsset
{
	GENERATED_BODY()
