...
FString FReEchoCombatVfxCatalog::ResolvePath(const EReEchoCombatVfxSemantic Semantic)
{
	...
	switch (Semantic)
	{
		...
		case EReEchoCombatVfxSemantic::PlayerGunFlightLightning:
			return TEXT(
			    "/Game/VFX/People/Bullet/Particle/NS_People_Bullet_Thunder_Fly.NS_People_Bullet_Thunder_Fly");
		case EReEchoCombatVfxSemantic::PlayerGunFlightGrass:
			return TEXT(
			    "/Game/VFX/People/Bullet/Particle/NS_People_Bullet_Grass_Fly.NS_People_Bullet_Grass_Fly");
		case EReEchoCombatVfxSemantic::PlayerGunFlightWater:
			return TEXT(
			    "/Game/VFX/People/Bullet/Particle/NS_People_Bullet_Water_Fly.NS_People_Bullet_Water_Fly");
		case EReEchoCombatVfxSemantic::PlayerGunImpact:
