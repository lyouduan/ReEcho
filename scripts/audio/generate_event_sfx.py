...
RECIPES: dict[str, Recipe] = {
    ...
    "Combat.Block": Recipe("Combat/Combat_Block.wav", 0.62, (Tone(480, 360, 0.30, 4.2, 0.0, "triangle"), Tone(1260, 1080, 0.25, 5.0), Tone(2140, 1840, 0.16, 6.5)), 0.20, 10.0, 0.18, (Pulse(0.0, 2800, 0.22, 70.0),), 0.075, 0.24),
    ...
    "Combat.Kill": Recipe("Combat/Combat_Kill.wav", 0.86, (Tone(110, 58, 0.50, 4.0, 0.0, "triangle"), Tone(420, 920, 0.24, 3.0, 0.12), Tone(880, 1380, 0.15, 4.5, 0.28)), 0.18, 8.0, 0.20, (Pulse(0.0, 980, 0.20, 52.0),), 0.12, 0.16),
    ...
    "Enemy.Attack": Recipe("Enemy/Enemy_Attack.wav", 0.56, (Tone(250, 92, 0.34, 5.0, 0.02, "saw"), Tone(720, 310, 0.13, 8.0, 0.09)), 0.31, 7.0, 0.07),
    ...
    "Boss.Spawn": Recipe("Boss/Boss_Spawn.wav", 3.20, (Tone(58, 82, 0.52, 0.7, 0.0, "triangle"), Tone(116, 164, 0.26, 0.8, 0.25), Tone(420, 760, 0.13, 1.3, 1.10)), 0.20, 1.2, 0.10, (Pulse(0.30, 72, 0.34, 7.0), Pulse(1.45, 64, 0.32, 6.0), Pulse(2.40, 54, 0.36, 5.0)), 0.24, 0.18),
    "Boss.Attack": Recipe("Boss/Boss_Attack.wav", 1.35, (Tone(82, 190, 0.46, 2.0, 0.0, "triangle"), Tone(360, 95, 0.24, 3.7, 0.52, "saw")), 0.30, 3.6, 0.09, (Pulse(0.72, 82, 0.45, 18.0),), 0.12, 0.16),
    ...
    "Echo.Spawn": Recipe("Echo/Echo_Spawn.wav", 0.82, (Tone(360, 1180, 0.36, 2.7, 0.04), Tone(920, 1760, 0.16, 4.0, 0.18)), 0.16, 5.0, 0.07, (), 0.10, 0.28),
    "Echo.Attack": Recipe("Echo/Echo_Attack.wav", 0.58, (Tone(560, 170, 0.30, 5.0, 0.02, "triangle"), Tone(1180, 420, 0.14, 7.0, 0.08)), 0.22, 7.0, 0.07, (), 0.085, 0.34),
    "Echo.End": Recipe("Echo/Echo_End.wav", 1.18, (Tone(980, 190, 0.34, 2.9, 0.0), Tone(1540, 330, 0.14, 4.2, 0.10)), 0.18, 4.5, 0.08, (), 0.14, 0.24),
