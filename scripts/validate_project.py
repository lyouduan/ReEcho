...
REGISTERED_BEHAVIOR_IDS = {
    ...
    "Card.GrantAllTier1",
    "Card.EasterShardThresholdGrantAllTier1",
    "Card.EasterGrantRandomCards",
    "Card.EasterStageBuff",
    "Card.EasterAscendInit",
    "Card.EasterExtraEchoes",
    "Card.EasterReshuffleTier1",
    "Card.EasterResetToBase",
    "Card.EasterGrow30",
...
CSV_TABLES: dict[str, dict[str, CsvColumnSpec]] = {
    ...
    "CardEffects": {
        ...
        "Target": CsvColumnSpec("StableId"),
        "ValueOp": CsvColumnSpec("ValueOp"),
        "Value": CsvColumnSpec("Float", min_value=-1000000.0, max_value=1000000.0),
        "BehaviorId": CsvColumnSpec("BehaviorId"),
        "ParamName": CsvColumnSpec("StableId"),
        "ParamValue": CsvColumnSpec("Float", min_value=-1000000.0, max_value=1000000.0),
    },
    "Elements": {
        "Id": CsvColumnSpec("StableId"),
        "SourceWorkbookId": CsvColumnSpec("StableId"),
