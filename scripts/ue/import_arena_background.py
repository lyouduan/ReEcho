...
SOURCE = Path(unreal.Paths.project_content_dir()) / "SourceArt" / "Scenes" / "ArenaBackground.png"
DESTINATION_PATH = "/Game/ReEcho/Textures/Scenes"
ASSET_NAME = "ArenaGround3D"

if not SOURCE.is_file():
    raise RuntimeError(f"Missing arena background source: {SOURCE}")
...
unreal.log(f"Imported arena background: {task.imported_object_paths[0]}")
