"""Import and verify the nine Plan152 Easter-card icons."""
...
CARD_IDS = [f"G_4_{index}" for index in range(1, 10)]
...
def main():
    ...
    unreal.log(f"[Plan152][EasterCardIconImport] imported={len(tasks)}")
