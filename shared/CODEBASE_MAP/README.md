...
| `AREA-Presentation` | 通用 2D 表现与世界适配 | `Source/ReEchoPresentation/`；主模块 Host 适配位于 `Source/ReEcho/{Public,Private}/Presentation/` | [Presentation](modules/MOD-ReEchoPresentation.md) |
