...
| 2D Sprite 动画、帧导入、逐帧 Query 轮廓、攻击/受击/死亡反馈 | `Presentation/Animation2D/*`、`Player/ReEchoPlayerPawn.*`、`Graybox/ReEchoEnemyActor.*`、`Graybox/ReEchoEchoActor.*` | `docs/2D_SEQUENCE_ANIMATION.md`、`docs/ART_ASSET_ORGANIZATION.md`、`scripts/ue/create_plan40_presentation_assets.py`、`scripts/ue/configure_plan40_flipbook_collision.py`、`Content/ReEcho/Art/Animation2D/`、`Content/ReEcho/Animation2D/`、`Content/SourceArt/Characters/` |
