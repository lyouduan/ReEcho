...
| Gavyn-side Planner | Plan29 / `plan/29-echo-storage-foundation` | `SharedContract` | `Active` | Core echo state, RunSubsystem, RunSaveGame and Plan29-only storage/save tests | Disjoint from Plans26/28. Plans30/31 consume only the accepted contract. |
