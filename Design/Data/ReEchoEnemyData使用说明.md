...
|---|---|---|---|
| `Enemies` | `tblEnemies` | `Content/Data/enemies.csv` | 四类敌人的稳定 `EnemyId`、基础属性、行为 Profile 与表现键 |
| `EnemyAbilities` | `tblEnemyAbilities` | `Content/Data/enemy_abilities.csv` | Boss 主动技能和元素清洗；以 `OwnerEnemyId` 关联敌人 |
...
6. `EnemyAbilities.OwnerEnemyId`、`BossPhases.BossEnemyId` 必须从 `tblEnemies[Id]` 下拉选择。
